	    ...
	    <div class="nav-wrapper top-nav purple darken-4">
	      <a href="#!" class="brand-logo center">Alaoui Zoubair</a>
      	  ...
      	  <ul class="right hide-on-med-and-down">
      	  	<li><a class="dropdown-button" href="#!" data-activates="language-dropdown">日本の<i class="material-icons right">arrow_drop_down</i></a></li>
      	  </ul>

      	  <ul class="side-nav" id="mobile-demo">
      	  	<li onclick="changeTab('test0')"><a><i class="material-icons">account_balance</i>&nbsp;自宅</a></br></li>
      	  	<li onclick="changeTab('test1')"><a><i class="material-icons">work</i>&nbsp;経験</a></br></li>
      	  	<li onclick="changeTab('test2')"><a><i class="material-icons">school</i>&nbsp;教育</a></br></li>
      	  	<li onclick="changeTab('test3')"><a><i class="material-icons">code</i>&nbsp;プロジェクト</a></br></li>
      	  	<li onclick="changeTab('test4')"><a><i class="material-icons">settings</i>&nbsp;技能</a></br></li>
      	  	<li onclick="changeTab('test5')"><a><i class="material-icons">language</i>&nbsp;言語</a></br></li>
			...
			<div id="test1" class="col s12">
					...
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								<h4 property="legalName">Cobham Aerospace Communications</h4>
								<h5 property="description">ソフトウェアエンジニアインターン</h5>
								<p property="description">
									Cobham Aerospace Communicationsは、欧州および国際航空機メーカーにACP（Audio Control Panel）とAMU（Audio Management Unit）を開発し、販売しています。
									<br/>
									IT部門の私の任務は、会社のSAVが使用するCRMアプリケーションとイントラネットを改装することです。 プロジェクトはWeb技術で開発されています<b>(HTML5 / CSS3 / PHP7 / Laravel5.1 / Bootstrap / Materializecss)</b> Linuxインフラストラクチャで実装されています <b>(Debian8.2 / Apache2 / Mysql 5.6)</b>.
									
								</p>
							</div>
							<div class="card-action">
									<span class="col s6 m6 align-left purple-text"><b>09/2015 - 現在</b></span>
									<span class="col s6 m6 right-align purple-text" property="location" typeof="Place"><b  property="address">ランジス - フランス</b></span>
									<br/>
							</div>
						</div>
					</div>
				...
				<div class="col s12 m6" property="worksFor" typeof="Organization">
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								<h4 property="legalName">Saham assurance</h4>
								<h5 property="description">ソフトウェア開発者</h5>
								<p property="description">
									サハム州はアフリカの約20カ国で主な活動を行っている大陸間保険グループです。
									<br/>
									IT部門の私の任務は、コンピュータ機器の保守を確実にし、サポートのためのコラボレータのポジションに介入することでした。 さらに、私はクライアントの契約のためにマルチリスク保険部門に出席し、同社のCRMを分析することができました。
							...
							<div class="card-action">
									...
									<span class="col s6 m6 right-align purple-text" property="location" typeof="Place"><b  property="address">マラケシュ - モロッコ</b></span>
									<br/>
							</div>
						</div>
					</div>
					...
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								...
								<h5 property="description">コンピュータ工学の学位</h5>
								<p property="description">
									Institut SupGaliléeは実践的なエンジニア訓練で有名で、学生が大規模プロジェクトに取り組み、重要な任務を遂行するように訓練します。
								</p>
									<br/><br/>
									<b>技能</b>
									<ul property="description">
										<li>データベース管理（Oracle 11g）</li>
										<li>Linuxの管理</li>
										<li>ネットワーク管理</li>
										<li>編集</li>
										<li>グラフ - アルゴリズム</li>
							...
							<div class="card-action">
									<span class="col s6 m6 align-left purple-text"><b>09/2014 - 現在</b></span>
									<span class="col s6 m6 right-align purple-text" property="location" typeof="Place"><b property="address">Villetaneuse - フランe</b></span>
									<br/>
							</div>
						</div>
					</div>
					...
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								...
								<h5 property="legalName">準備クラス</h5>
								<p property="legalName">
									学校のプログラムは将来のエンジニアが準備クラスのプログラムに基づいて軸を持っている間、専門分野に関して知識を取得することができます。
								</p>
									<br/><br/>
									<b>技能</b>
									<ul property="legalName">
										<li>オブジェクト指向プログラミング（アルゴリズム/ C ++ / JAVA）</li>
										<li>データベース管理</li>
										<li>電子電気回路</li>
										<li>マイクロコントローラ - アセンブリ</li>
										<li>Linux</li>
										<li>Ciscoルータの設定</li>
									</ul>
					...
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								...
								<h5 property="description">ソーシャルネットワーク</h5>
								<p property="description">
									ユーザーの衣装を管理し、各人の服のスタイルを決定して、その人のプロフィールに対応する記事を提案するマルチプラットフォームソーシャルネットワーク。
								</p>
									<br/><br/>
									<b>テクノロジー</b>
									<ul property="description">
							...
							<div class="card-action">
									<span class="col s6 m6 align-left purple-text"><b>11/2014 - 現代</b></span>
									<span class="col s6 m6 right-align purple-text"><b>Villetaneuse - フランス</b></span>
									<br/>
							</div>
						</div>
					</div>
					...
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								...
								<p property="description">
									もはやWebポータルの基準を満たさないサービスイントラネットを改装するためにIT部門内で開発されたアプリケーション。 目的は、アプリケーションの視点からの修理の管理を容易にし、格納された情報を抽出して分析するためにデータを処理するために、SAVの適用を更新することである。
								</p>
									<br/><br/>
									<b>テクノロジー</b>
									<ul property="description">
							...
							<div class="card-action">
									<span class="col s6 m6 align-left purple-text"><b>09/2016 - 現代</b></span>
									<span class="col s6 m6 right-align purple-text"><b>Rungis - フランス</b></span>
									<br/>
							</div>
						</div>
					</div>
					...
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								...
								<h5 property="description">スクールドローンクラブ</h5>
								<p property="description">
									ガリレオ研究所でのイノベーションを発展させるために、私は、ロボットの将来を計画する際に学生が時間を逆転させるために、学校のロボットクラブと協力して無人機クラブを創設することに着手しました。 。 現在、キャンパス内の学生が作成したドローンをテストするためのフライトクリアランスを取得するための行政手続が進行中です。
									<br/><br/>
								</p>
							</div>
							<div class="card-action">
									<span class="col s6 m6 align-left purple-text"><b>10/2016 - 現代</b></span>
									<span class="col s6 m6 right-align purple-text"><b>Villetaneuse - フランス</b></span>
									<br/>
							</div>
						</div>
					...
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								...
								<p property="description">
									CRMは、テクニカル仕様の作成を担当する開発者であったクエリを処理するための顧客関係サービス用に開発されました。 アプリケーションは、クライアントとドキュメントに送信された回答の履歴を保持して、質問に答えることを可能にします。 このアプリケーションは、いくつかの基準に関連して統計を実行することも可能にします。
								</p>
									<br/><br/>
									<b>テクノロジー</b>
									<ul property="description">
			...
			<div id="test4" class="col s12">
				<div class="col s12 m4">
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								<h5 property="legalName">Web開発</h5>
								<p>
								</p>
							</div>
						</div>
					...
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content" property="memberOf" typeof="Organization">
								<h5 property="legalName">Webセマンティック</h5>
								<p>
								</p>
							</div>
						</div>
				...
				<div class="col s12 m4">
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content" property="memberOf" typeof="Organization">
								<h5 property="legalName">Linuxの管理</h5>
								<p>
								</p>
							</div>
						</div>
				...
				<div class="col s12 m4">
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content" property="memberOf" typeof="Organization">
								<h5 property="legalName">侵入テスト</h5>
								<p></p>
							</div>
						</div>
					</div>
				...
				<div class="col s12 m4">
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content" property="memberOf" typeof="Organization">
								<h5 property="legalName">アジャイルスクラム</h5>
								<p></p>
							</div>
						</div>
					</div>
				...
				<div class="col s12 m4">
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content" property="memberOf" typeof="Organization">
								<h5 property="legalName">データベース管理</h5>
								<p>
								</p>
							</div>
						</div>
			...
			<div id="test5" class="col s12">
				...
				<div class="col s12 m4">
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								<h4 property="description">フランス語</h4>
								<h5>
									熟練:   
									<span class="progress">
				...
				<div class="col s12 m4">
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								<h4 property="description">アラビア語</h4>
								<h5>
									熟練:   
									<span class="progress">
										<span class="determinate" style="width: 100%"></span>
				...
				<div class="col s12 m4">
					<div class="card ">
						...
						<div class="card-stacked">
							<div class="card-content">
								<h4 property="description">ドイツ人</h4>
								<h5>
									熟練:   
									<span class="progress">
